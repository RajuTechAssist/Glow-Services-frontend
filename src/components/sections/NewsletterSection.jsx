...
const NewsletterSection = () => {
  ...
  if (isSubscribed) {
    return (
      <section className="py-24 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/30 dark:to-emerald-900/30 relative overflow-hidden transition-colors duration-300">
  ...
  return (
    <section 
      ref={sectionRef}
      className="py-24 bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 relative overflow-hidden transition-colors duration-300"
    >
      {/* Background Decorative Elements */}
      <div className="absolute inset-0">
        <div className="absolute top-20 left-20 w-64 h-64 bg-purple-200/30 dark:bg-purple-900/10 rounded-full mix-blend-multiply dark:mix-blend-overlay filter blur-xl animate-pulse"></div>
        <div className="absolute bottom-20 right-20 w-80 h-80 bg-pink-200/30 dark:bg-pink-900/10 rounded-full mix-blend-multiply dark:mix-blend-overlay filter blur-xl animate-pulse"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-indigo-200/20 dark:bg-indigo-900/10 rounded-full mix-blend-multiply dark:mix-blend-overlay filter blur-2xl"></div>
      </div>

      {/* Floating Icons */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-16 left-1/4 text-purple-300 dark:text-purple-700 animate-bounce" style={{ animationDelay: '0s' }}>
          <Mail className="h-6 w-6" />
        </div>
        <div className="absolute top-32 right-1/3 text-pink-300 dark:text-pink-700 animate-bounce" style={{ animationDelay: '1s' }}>
          <Sparkles className="h-8 w-8" />
        </div>
        <div className="absolute bottom-32 left-1/6 text-indigo-300 dark:text-indigo-700 animate-bounce" style={{ animationDelay: '2s' }}>
          <Gift className="h-7 w-7" />
        </div>
        <div className="absolute bottom-16 right-1/4 text-rose-300 dark:text-rose-700 animate-bounce" style={{ animationDelay: '3s' }}>
          <Heart className="h-5 w-5 fill-current" />
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-16">
          <div className={`inline-flex items-center space-x-2 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-full px-6 py-3 shadow-lg border border-purple-100 dark:border-purple-900 mb-6 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <Mail className="h-5 w-5 text-purple-500 dark:text-purple-400" />
            <span className="text-purple-600 dark:text-purple-400 font-medium tracking-wide uppercase text-sm">
              Stay Beautiful
            </span>
          </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="block w-full pl-12 pr-4 py-4 text-gray-900 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-300 text-lg dark:text-white dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                      disabled={isLoading}
                    />
                  </div>
                  {error && (
          ...
          <div className={`space-y-8 transition-all duration-1000 delay-500 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-8'}`}>
            ...
            {benefits.map((benefit, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div>
                    <h4 className="text-xl font-bold text-gray-900 dark:text-white mb-2 group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors duration-300">
                      {benefit.title}
                    </h4>
            ...
            <div className="bg-gradient-to-r from-purple-100 to-pink-100 dark:from-purple-900/40 dark:to-pink-900/40 rounded-2xl p-6 mt-8">
              <div className="flex items-center space-x-3 mb-3">
                <div className="w-8 h-8 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full flex items-center justify-center">
                  <Star className="h-4 w-4 text-white fill-current" />
                </div>
                <h4 className="text-lg font-bold text-gray-900 dark:text-white">VIP Treatment</h4>
              </div>
