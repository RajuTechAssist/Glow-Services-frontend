    ...
    return (
      <div className="min-h-screen pt-20 flex items-center justify-center dark:bg-gray-900">
        <div className="text-center max-w-md mx-auto px-4">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-8">Add some services to your cart to continue</p>
          <button
  ...
  return (
    <div className="min-h-screen pt-20 bg-gray-50 dark:bg-gray-900">
      <div className="container mx-auto px-4 py-8">
        ...
        {/* Page Header */}
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-2">Your Cart</h1>
          <p className="text-gray-600 dark:text-gray-400">Review your selected services and proceed to booking</p>
        </div>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-bold text-gray-900 dark:text-white">Selected Services ({items.length})</h2>
                <button
                  onClick={clearCart}
              ...
              <div className="space-y-4">
                {items.map((item) => (
                  <div key={item.id} className="flex items-center space-x-4 p-4 border border-gray-200 dark:border-gray-700 rounded-xl hover:border-pink-300 dark:hover:border-pink-500 transition-colors duration-200">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-600 dark:text-gray-400 text-sm capitalize">{item.category} • {item.duration}</p>
                      <p className="text-pink-600 dark:text-pink-400 font-bold text-lg">₹{item.price}</p>
                    </div>
                    ...
                    <div className="flex items-center space-x-3">
                      <button
                        ...
                        className="w-10 h-10 flex items-center justify-center bg-gray-100 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors duration-200 text-gray-700 dark:text-gray-200"
                      >
                        <Minus className="h-4 w-4" />
                      </button>
                      <span className="w-8 text-center font-medium text-lg text-gray-900 dark:text-white">{item.quantity}</span>
                      <button
                        onClick={() => updateQuantity(item.id, item.quantity + 1)}
                        className="w-10 h-10 flex items-center justify-center bg-gray-100 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors duration-200 text-gray-700 dark:text-gray-200"
                      >
                    ...
                    <div className="text-right">
                      <p className="text-xl font-bold text-gray-900 dark:text-white">₹{item.price * item.quantity}</p>
                    </div>
                    ...
                    <div className="flex flex-col space-y-2">
                      ...
                      <button
                        ...
                        className="px-4 py-2 bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 text-sm font-medium rounded-lg hover:bg-red-100 dark:hover:bg-red-900/40 transition-colors duration-200 flex items-center space-x-2"
                      >
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 sticky top-24">
              ...
              <div className="border-t dark:border-gray-700 pt-4 mb-6">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-2xl font-bold text-pink-600 dark:text-pink-400">₹{getTotalPrice()}</span>
                </div>
              </div>
