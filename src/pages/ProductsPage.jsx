        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center">
            ...
            <p className="text-lg md:text-xl text-pink-100 max-w-3xl mx-auto leading-relaxed">
              ...
              top brands. From skincare essentials to makeup must-haves, find
                ...
                <div>
                  ...
                  <p className="text-pink-600 dark:text-pink-400 mt-2 flex items-center">
                    ...
                    {loading
                      ...
                      : `${products.length} beautiful product${
                          products.length !== 1 ? "s" : ""
                        } found`}
                  </p>
                </div>
                  ...
                  <p className="text-purple-600 dark:text-purple-400 text-lg">
                    {searchTerm ? (
                      ...
                      <>
                        ...
                        {getCategoryById(selectedCategory)?.name}" right now.
                        Check back soon! ✨
                      </>
                    ) : (
                    ...
                    >
                      ...
                      <div className="relative h-64 overflow-hidden bg-gradient-to-br from-pink-100 to-purple-100 dark:from-gray-700 dark:to-purple-900">
                        {product.images && product.images.length > 0 ? (
                          ...
                          <div
                            className={`w-full h-full bg-gradient-to-br ${getProductImage(
                              product
                          ...
                          >
                            ...
                            <div className="font-bold text-lg text-center px-4">
                              {product.name}
                            </div>
                          </div>
                        )}
                      ...
                      <div className="p-6">
                        ...
                        <div className="flex gap-3">
                          ...
                          >
                            <ShoppingCart className="w-sm h-5 mr-2" />
